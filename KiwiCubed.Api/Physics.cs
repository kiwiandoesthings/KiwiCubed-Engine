...
public class Physics {
	...
	public static void ApplyPhysics(IChunkHandler virtualChunkHandler, ref EntityTransformComponent transform, ref EntityPhysicalComponent physicalComponent, int tps, double delta) => physics.ApplyPhysics(virtualChunkHandler, ref transform, ref physicalComponent, tps, delta);
...
public interface IPhysics {
	public void ApplyPhysics(IChunkHandler virtualChunkHandler, ref EntityTransformComponent transform, ref EntityPhysicalComponent physicalComponent, int tps, double delta);
